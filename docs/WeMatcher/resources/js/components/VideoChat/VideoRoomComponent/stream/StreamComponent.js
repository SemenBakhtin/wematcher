            ...
            <div className="OT_widget-container">
                <div className="nickname">
                    <div>
                        ...
                        {this.props.user.isRemote() && this.props.user.getVerified() && 
                            <span className={'ml-4 mr-4 flag-icon flag-icon-' + this.props.user.getCountry().toLowerCase() } title={Constants.COUNTRY[this.props.user.getCountry()]}>
                            </span>
                        }
                        {this.props.user.isRemote() && this.props.user.getVerified() && 
                            <span>{this.props.user.getAge()}</span>
                        }
                    </div>
                </div>
