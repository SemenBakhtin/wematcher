...
class Constants {
    public static $MSGCNT = 30;
    public static $LOCALE = ['en' => ['English', 'us'], 'ru' => ['русский', 'ru'], 'cn' => ['中文', 'cn']];
    public static $COUNTRY = ['AD' => 'Andorra', 'AE' => 'United Arab Emirates', 'AF' => 'Afghanistan', 'AG' => 'Antigua and Barbuda', 'AI' => 'Anguilla'
